    ...
    return <div className="flex h-[100vh] flex-col">
        ...
        <main className="grow flex justify-center">
            <div className="w-full px-5 flex flex-col items-center mt-44">
                <img className="w-[172px] md:w-[272px]" src={Logo} alt="google" />
                <SearchInput />
                <div className="flex gap-2 text-[#3c40403]mt-8 ">
                    ...
                    <button className="h-9 px-4 bg-[#f8f9fa] text-sm rounded-md border- [#f8f9fa] hover:border-[#dadce0] hover:shadow-c2">I'm Feeling Lucky</button>
                </div>
            </div>
        </main>
